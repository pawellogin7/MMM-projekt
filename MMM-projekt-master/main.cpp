...
LRESULT CALLBACK WndProc(HWND hwnd, UINT Message, WPARAM wParam, LPARAM lParam) {
	switch(Message) {
		...
		case WM_CREATE: {
			...
			SendMessage( U_combo, CB_ADDSTRING, 0,( LPARAM ) "Fala Prostokątna" );
			...
			//------------Przebiegi------------------
			Okno_button = CreateWindowEx(0, "BUTTON", "Rysuj przebiegi sygnałów", WS_CHILD | WS_VISIBLE,
				50,
				450,
				200,
				50,
...
LRESULT CALLBACK WndProcInput(HWND hwnd3, UINT Message, WPARAM wParam, LPARAM lParam) {
	switch(Message) {
		...
		//---Wybor treści kontrolek w zależności od naciśniętego przycisku w oknie głównym---
		case WM_CREATE: {
			switch(input_typ)
			{
				case 1:{
					Input_static = CreateWindowEx( 0, "STATIC", "Zmień wartość rezystancji R1", WS_CHILD | WS_VISIBLE | SS_CENTER,
					50, /* x */
					20, /* y */
					300, /* width */
					20, /* height */
				...
				case 2:{
					Input_static = CreateWindowEx( 0, "STATIC", "Zmień wartość rezystancji R2", WS_CHILD | WS_VISIBLE | SS_CENTER,
					50, /* x */
					20, /* y */
					300, /* width */
					20, /* height */
				...
				case 3:{
					Input_static = CreateWindowEx( 0, "STATIC", "Zmień wartość pojemności C1", WS_CHILD | WS_VISIBLE | SS_CENTER,
					50, /* x */
					20, /* y */
					300, /* width */
					20, /* height */
				...
				case 4:{
					Input_static = CreateWindowEx( 0, "STATIC", "Zmień wartość pojemności C2", WS_CHILD | WS_VISIBLE | SS_CENTER,
					50, /* x */
					20, /* y */
					300, /* width */
					20, /* height */
				...
				case 5:{
					Input_static = CreateWindowEx( 0, "STATIC", "Zmień wartość amplitudy sygnału", WS_CHILD | WS_VISIBLE | SS_CENTER,
					50, /* x */
					20, /* y */
					300, /* width */
					20, /* height */
				...
				case 6:{
					Input_static = CreateWindowEx( 0, "STATIC", "Zmień wartość częstotliwości sygnału", WS_CHILD | WS_VISIBLE | SS_CENTER,
					50, /* x */
					20, /* y */
					300, /* width */
					20, /* height */
			...
			switch (wParam)
			{
				case VK_RETURN: {
					...
					if(IsNumber(Bufor) != -1)
					{
						...
						MessageBox( hwnd, "Podaj liczbę z zakresu <1e-12; 1e15>", NULL, MB_ICONINFORMATION );
					switch(input_typ)
					{
						case 1:
							SetWindowText(Input_text, GetValue(R1, '-'));
...
//Liczba wyświetlana jest z zakresu <1;999> z dodatkowym przedrostkiem, jesli jest potrzebny
